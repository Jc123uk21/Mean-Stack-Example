...
Next to conclude building out our backend we next create our authorization and authentication utility class to handle requests for creating new users, logging in users. This utility class will add new users to our database, check wheather users logging in exist within our database and handle creating our jason web tokens for registered users.
